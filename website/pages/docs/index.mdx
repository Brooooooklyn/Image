...
### Render the SVG to Other Image Format
...
> The value 0 corresponds to low quality and small output sizes, whereas 100 is the highest quality and largest output size. <br/> > https://developers.google.com/speed/webp/docs/api#simple_encoding_api <br/>
> Default is 90
...
![with-exif.jpg](/img/with-exif.jpg)
...
| Image                     | Output                              |
| ------------------------- | ----------------------------------- |
| ![un-optimized.png](/img/un-optimized.png) | ![grayscale.manipulated.webp](/img/grayscale.manipulated.webp) |
...
| Image                     | Output                           |
| ------------------------- | -------------------------------- |
| ![un-optimized.png](/img/un-optimized.png) | ![invert.manipulated.webp](/img/invert.manipulated.webp) |
...
| Image                     | Output                         |
| ------------------------- | ------------------------------ |
| ![un-optimized.png](/img/un-optimized.png) | ![blur.manipulated.webp](/img/blur.manipulated.webp) |

#### `unsharpen`

> Performs an unsharpen mask on this image. <br/> `sigma` is the amount to blur the image by. <br/> > `threshold` is a control of how much to sharpen. <br />
...
| Image                 | Output                              |
| --------------------- | ----------------------------------- |
| ![taj_orig.jpg](/img/taj_orig.jpg) | ![unsharpen.manipulated.webp](/img/unsharpen.manipulated.webp) |
...
> https://en.wikipedia.org/wiki/Kernel_(image_processing)#Details <br/>
> Sharpen:
...
| Image                     | Output                              |
| ------------------------- | ----------------------------------- |
| ![un-optimized.png](/img/un-optimized.png) | ![filter3x3.manipulated.webp](/img/filter3x3.manipulated.webp) |
...
| Image                     | Output                             |
| ------------------------- | ---------------------------------- |
| ![un-optimized.png](/img/un-optimized.png) | ![contrast.manipulated.webp](/img/contrast.manipulated.webp) |
...
| Image                     | Output                             |
| ------------------------- | ---------------------------------- |
| ![un-optimized.png](/img/un-optimized.png) | ![brighten.manipulated.webp](/img/brighten.manipulated.webp) |
...
| Image                     | Output                              |
| ------------------------- | ----------------------------------- |
| ![un-optimized.png](/img/un-optimized.png) | ![huerotate.manipulated.webp](/img/huerotate.manipulated.webp) |
...
| Image                     | Output                         |
| ------------------------- | ------------------------------ |
| ![un-optimized.png](/img/un-optimized.png) | ![crop.manipulated.webp](/img/crop.manipulated.webp) |
