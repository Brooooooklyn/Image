...
| Image                     | Output                              |
| ------------------------- | ----------------------------------- |
| ![](img/un-optimized.png) | ![](img/grayscale.manipulated.webp) |
...
| Image                     | Output                           |
| ------------------------- | -------------------------------- |
| ![](img/un-optimized.png) | ![](img/invert.manipulated.webp) |
...
| Image                     | Output                         |
| ------------------------- | ------------------------------ |
| ![](img/un-optimized.png) | ![](img/blur.manipulated.webp) |
...
| Image                 | Output                              |
| --------------------- | ----------------------------------- |
| ![](img/taj_orig.jpg) | ![](img/unsharpen.manipulated.webp) |
...
| Image                     | Output                              |
| ------------------------- | ----------------------------------- |
| ![](img/un-optimized.png) | ![](img/filter3x3.manipulated.webp) |
...
| Image                     | Output                             |
| ------------------------- | ---------------------------------- |
| ![](img/un-optimized.png) | ![](img/contrast.manipulated.webp) |
...
| Image                     | Output                             |
| ------------------------- | ---------------------------------- |
| ![](img/un-optimized.png) | ![](img/brighten.manipulated.webp) |
