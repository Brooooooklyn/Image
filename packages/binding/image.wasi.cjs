// napi-rs-artifact-metadata:{"version":2,"rootEntry":"index.js","exports":["Transformer","BlendMode","ChromaSubsampling","CompressionType","compressJpeg","compressJpegSync","FastResizeFilter","FilterType","Gravity","JsColorType","losslessCompressPng","losslessCompressPngSync","Orientation","pngQuantize","pngQuantizeSync","PngRowFilter","ResizeFilterType","ResizeFit"],"managedRootEntries":["browser.js","index.js","image.wasm","image.debug.wasm"]}
/* eslint-disable */
...
if (__nodeFs.existsSync(__wasmDebugFilePath)) {
  ...
  const __wasiPackageEntry = require.resolve('@napi-rs/image-wasm32-wasi')
  ...
  if (!__nodeFs.existsSync(__packagedWasmFilePath)) {
    throw new Error(
      '@napi-rs/image-wasm32-wasi is installed but is missing image.wasm32-wasi.wasm.',
    )
  }
